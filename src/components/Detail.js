        ...
        return (
            <View style={styles.detailContainer}>
                <View style={styles.headerContainer}>
                    ...
                    <Svg width="160" height="160" viewBox="0 0 103 88" style={styles.communeSvg}>
                            <Path d={this.state.path} fill="none" stroke="#472c0e" stroke-width="2"/>
                    </Svg>
                ...
                <ScrollView>
                    ...
                    <View style={{marginVertical: 18, justifyContent:'center', alignItems:'center'}}>  
                        <Svg width="80" height="80" viewBox="0 0 103 88">
